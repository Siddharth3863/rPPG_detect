...
const RecordSessionPhys = () => {
    ...
    const handleFileSubmit = async (event) => {
        ...
        if (selectedFile) {
            ...
            try {
                const response = await fetch('http://localhost:5000/upload-phys', {
                    method: 'POST',
                    body: formData,
                });
    ...
    return (
        <div className="container mt-5">
            <h1 className="text-center">Record Session Using PhysNet</h1>
...
export default RecordSessionPhys;
