...
const RecordSessionPFE = () => {
    ...
    const handleFileSubmit = async (event) => {
        ...
        if (selectedFile) {
            ...
            try {
                const response = await fetch('http://localhost:5000/upload-pfe', {
                    method: 'POST',
                    body: formData,
                });
    ...
    return (
        <div className="container mt-5">
            <h1 className="text-center">Record Session Using PFE/TFA</h1>
...
export default RecordSessionPFE;
